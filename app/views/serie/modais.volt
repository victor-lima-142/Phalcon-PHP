		...
		<div class="modal-content bg-white bg-gradient shadow border-0 rounded-0">
			...
			<div class="modal-body">
				{{ form('nova-serie', 'method': 'post', 'enctype' : 'multipart/form-data', 'name':'novaSerie') }}
					...
					<div class="mb-3">
						<label for="nome" class="form-label">Nome</label>
						{{ text_field("nome", "width": '100%', "class": 'form-control fs-6') }}
					</div>

					<div class="mb-3">
						<label for="descricao" class="form-label">Descrição</label>
						{{ text_area("descricao", "width": '100%', "class": 'form-control fs-6', 'rows': '5') }}
					</div>

					<div class="mb-3">
						<label for="avaliacao" class="form-label">Avaliação</label>

						{{ numeric_field('avaliacao', 'min': '1', 'max': '5', 'class': 'form-control fs-6') }}
					</div>
